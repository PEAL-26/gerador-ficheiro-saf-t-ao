...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div>
      <nav className="fixed top-0 left-0 z-50 w-full border-gray-200 bg-gray dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="mx-auto w-full max-w-screen-xl">
            <div className="px-6 py-3 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
                ...
                <a href="/">{NOME_SITE}</a>. Todos direitos reservados.
              </span>
